...
function compileHomeScreen() {
	...
	homeScreen.push(frameLine);
	homeScreen.push( pad(10, '%c(green2)Welcome, today is Friday, 15th of November. It\'s your Birthday! :D%c(0)') ); //'+logDate+'
	homeScreen.push(frameLine);
...
function termInitHandler() {
	this.type('sids@SIDS-PC:~/special/aju$');
	this.cursorOn();
	var opts='';
